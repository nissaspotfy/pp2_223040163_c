  ...
  public int update(Member member) {
    ...
    try {
      ...
      PreparedStatement statement = connection
          .prepareStatement("update member set nama = ?, jenis_member_id = ? where id = ?");
  ...
  public List<Member> findAll() {
    ...
    try {
      ...
      PreparedStatement statement = connection.prepareStatement(
          "select member.id, member.nama, jenis_member_id, jenis_member.nama as jenis_member_nama from member join jenis_member on jenis_member.id = member.jenis_member_id");
